...
const Team = () => {
  return (
    <section className="relative z-10 font-inter my-24 px-16 bg-white  py-14 rounded-[45px] w-full">
      <div className="flex items-center justify-between">
        <div>
          <p className="mb-5 font-medium flex items-center">
            <span className="w-3.5 h-3.5 bg-[#305FD3] block mr-3 rounded-sm"></span>
            TEAM
          </p>
          <h2 className="font-semibold text-[35px] w-[424px] mb-3">
